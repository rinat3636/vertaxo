...
export const metadata: Metadata = {
  title:
    "Компьютерная помощь в Москве и удалённо по всей России | VERTAXO",
  description:
    "Компьютерная помощь: выезд в Москве и Московской области, удалённая поддержка по всей России. Поддержка пользователей, администрирование 1С, настройка сетей, информационная безопасность, резервное копирование. Оставьте заявку — ответим быстро.",
  ...
  return (
    <>
      ...
      <Hero
        ...
        subtitle="Поддержка пользователей, администрирование и информационная безопасность для дома и бизнеса — в Москве и Московской области, удалённо по всей России"
