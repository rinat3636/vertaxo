...
export const metadata: Metadata = {
  title:
    "Компьютерная помощь и IT-администрирование по всей России | VERTAXO",
  description:
    "Компьютерная помощь удалённо по всей России: поддержка пользователей, администрирование 1С, настройка сетей, информационная безопасность, резервное копирование. Оставьте заявку — ответим быстро.",
...
const stats = [
  ...
  { value: "Вся Россия", label: "удалённая помощь и выезд к клиенту" },
] as const;
...
const faq = [
  {
    ...
    a: "Да, большинство задач решаем удалённо — поэтому работаем с клиентами по всей России. При необходимости возможен выезд к вам.",
  },
  {
  ...
  return (
    <>
      ...
      <Hero
        ...
        subtitle="Поддержка пользователей, администрирование и информационная безопасность для дома и бизнеса — удалённо по всей России"
