...
export const metadata: Metadata = {
  title:
    "matritsa — IT поддержка организаций, 3D-печать и инженерные разработки в Москве и МО",
  description:
    "IT поддержка организаций и защита данных, 3D-моделирование и печать, инженерные разработки в Москве и Московской области, удалённо по всей России. Получите консультацию.",
  alternates: { canonical: SITE_URL },
  openGraph: {
    title: "matritsa — IT поддержка организаций, 3D-печать и инженерные разработки",
    description:
      "IT поддержка организаций, 3D-моделирование и печать, инженерные разработки. Москва и МО, удалённо по всей России.",
    url: SITE_URL,
    images: [
      {
...
const services = [
  ...
  },
  {
    ...
    imageMobile: "/images/3d-printing-mobile.webp",
    imageAlt:
  ...
  },
  {
    ...
    imageMobile: "/images/engineering-mobile.webp",
    imageAlt:
...
const stats = [
  { value: "25+ лет", label: "опыта в сфере IT и инженерии" },
...
const faq = [
  ...
  },
  {
    ...
    a: "Да, работаем с юридическими лицами: договор, счёт от ИП, закрывающие документы, возможно абонентское IT-обслуживание.",
  },
  {
...
export default function HomePage() {
  return (
    <>
      ...
      />
      <Hero
        title="IT поддержка организаций и защита данных, 3D-печать и моделирование, собственные инженерные разработки и создание сайтов"
